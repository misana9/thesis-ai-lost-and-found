...
def get_user_by_token_data(db: Session, token_data: schemas.tokenData) -> models.Users | None:
...
def get_optional_user(
    ...
    try:
        ...
        return None
    return get_user_by_token_data(db, token_data)
...
def get_admin_user(
    ...
    user = get_user_by_token_data(db, token_data)
